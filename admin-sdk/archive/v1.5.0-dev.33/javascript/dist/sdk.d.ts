...
export class Admin {
  ...
  adminResyncS3BucketAllowlists(): Promise<Record<string, any>>;
...
export class Company {
  ...
  updateCompanyPhotoUrlAllowlist(companyId: number, photoUrlAllowlist: string[]): Promise<Record<string, any>>;
...
export class Search {
  ...
  searchProjectPhotosNaturalLanguage(projectTableName: string, searchText: string, options?: { minCosine?: number | number[], labelMinCosine?: number | number[], labelTopK?: number | number[], labelDelta?: number | number[], bestOfSimilarSetsOnly?: boolean | boolean[], splitByTier?: boolean | boolean[] }): Promise<Record<string, any>>;
...
export class Users {
  ...
  createUserAndCompany(name: string, email: string, password: string, companyId?: number, profilePicture?: string, paymentPlanType?: string, companyName?: string, credits?: number, photoUrlAllowlist?: string[], options?: { inviteToken?: string | string[] }): Promise<UserDisplay>;
