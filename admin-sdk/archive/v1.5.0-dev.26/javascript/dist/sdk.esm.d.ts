...
export class Photoupload {
  uploadPhotoToMediaviz(body: { fileContent: string, mimetype: string, filePath: string, companyId: string, userId: string, projectTableName: string, clientSideId?: string, format?: string, size?: string, sourceResolutionX?: any, sourceResolutionY?: any, dateTaken?: string, latitude?: any, longitude?: any, blur: any, colors: any, faceRecognition: any, imageDescribe: any, imageClassification: any, imageComparison: any, ocr: any }): Promise<any>;
