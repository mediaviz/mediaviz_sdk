...
describe('PhotoUpload', () => {
  ...
  it('uploadPhotoToMediaviz — HTTP method is POST', async () => {
    ...
    await photoupload.uploadPhotoToMediaviz('test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', { clientSideId: 'test_value', format: 'test_value', size: 'test_value', sourceResolutionX: 'test_value', sourceResolutionY: 'test_value', dateTaken: 'test_value', latitude: 'test_value', longitude: 'test_value' });
  ...
  it('uploadPhotoToMediaviz — request body', async () => {
    ...
    expect(body).toHaveProperty('judgment_model');
