(function (global, factory) {
	...
	class Admin {
	  ...
	  async adminCreateLabelVocabIndex() {
	    this._ctx.requireTokens();
	    const path = `/api/v1/admin/search/create_label_vocab_index`;
	    const { data } = await this._ctx.client.request(path, 'POST', this._ctx.accessToken, this._ctx.refreshToken);
	    return data;
	  }
	...
	class Search {
	  ...
	  async searchProjectPhotosParametrized(projectTableName, { andParams, orParams, notParams, dateMin, dateMax, dateNullAnd, dateNullOr, dateOrder, albums, bestOfSimilarSetsOnly, splitByTier, size } = {}) {
	    this._ctx.requireTokens();
	  ...
	  async searchProjectPhotosNaturalLanguageAuto(projectTableName, searchText, size = undefined, { minCosine, labelMinCosine, labelTopK, labelDelta, bestOfSimilarSetsOnly, splitByTier } = {}) {
	    this._ctx.requireTokens();
