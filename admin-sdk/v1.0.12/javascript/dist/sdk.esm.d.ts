...
export class OauthClients {
  createClient(clientName: string, clientType: string, redirectUris: any, isFirstParty: boolean): Promise<Record<string, any>>;
}
...
export class Search {
  ...
  searchProjectPhotosParametrized(projectTableName: string, options?: { andParams?: any, orParams?: any, notParams?: any, dateMin?: string | string[], dateMax?: string | string[], dateNullAnd?: boolean | boolean[], dateNullOr?: boolean | boolean[], dateOrder?: string | string[], albums?: any, bestOfSimilarSetsOnly?: boolean | boolean[], splitByTier?: boolean | boolean[], size?: number | number[] }): Promise<Record<string, any>>;
  searchProjectPhotosNaturalLanguageAuto(projectTableName: string, searchText: string, size?: number, options?: { minCosine?: number | number[], labelMinCosine?: number | number[], labelTopK?: number | number[], labelDelta?: number | number[], bestOfSimilarSetsOnly?: boolean | boolean[], splitByTier?: boolean | boolean[] }): Promise<Record<string, any>>;
