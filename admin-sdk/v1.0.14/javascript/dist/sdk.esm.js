...
class Search {
  ...
  async searchProjectPhotosParametrized(projectTableName, { searchText, notSearchText, city, country, state, albums, dateMin, dateMax, dateNullAnd, dateNullOr, dateOrder, bestOfSimilarSetsOnly, splitByTier, size } = {}) {
    this._ctx.requireTokens();
