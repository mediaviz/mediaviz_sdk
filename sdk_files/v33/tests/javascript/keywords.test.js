...
describe('Keywords', () => {
  ...
  it('createKeywordFilteringList — HTTP method is POST', async () => {
    ...
    await keywords.createKeywordFilteringList({ Model: 'test_value' });
  ...
  it('updateKeywordFilteringListLabels — HTTP method is PUT', async () => {
    ...
    const ctx = { client: spy, accessToken: 'access_token', refreshToken: 'refresh_token', requireTokens: () => {} };
    const keywords = new Keywords(ctx);
    await keywords.updateKeywordFilteringListLabels(42, { Model: 'test_value' });
  ...
  it('updateKeywordFilteringListDetails — HTTP method is PUT', async () => {
    ...
    const ctx = { client: spy, accessToken: 'access_token', refreshToken: 'refresh_token', requireTokens: () => {} };
    const keywords = new Keywords(ctx);
    await keywords.updateKeywordFilteringListDetails(42, { Model: 'test_value' });
    expect(spy.last_call().method).toBe('PUT');
  });
  ...
  it('addProjectToKeywordFilteringList — exists', () => {
    const keywords = new Keywords({});
    expect(typeof keywords.addProjectToKeywordFilteringList).toBe('function');
  });
  ...
  it('addProjectToKeywordFilteringList — HTTP method is POST', async () => {
    ...
    const ctx = { client: spy, accessToken: 'access_token', refreshToken: 'refresh_token', requireTokens: () => {} };
    const keywords = new Keywords(ctx);
    await keywords.addProjectToKeywordFilteringList(42, { projectIds: 'test_value' });
    expect(spy.last_call().method).toBe('POST');
  });
