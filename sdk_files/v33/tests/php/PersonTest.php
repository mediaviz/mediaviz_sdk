...
class PersonTest extends TestCase {
    ...
    public function test_put_update_person_path(): void {
        ...
        $obj = new Person($ctx);
        $obj->updatePerson('test_value', 'test_value', 'test_value');
        $this->assertStringContainsString('/api/v1/person/test_value/test_value', $ctx->client->lastCall()['path']);
    }
    ...
    public function test_put_combine_persons_path(): void {
        ...
        $obj = new Person($ctx);
        $obj->combinePersons('test_value', 'test_value', 'test_value');
        $this->assertStringContainsString('/api/v1/person/test_value/combine/test_value/test_value', $ctx->client->lastCall()['path']);
    }
    ...
    public function test_put_split_persons_path(): void {
        ...
        $obj = new Person($ctx);
        $obj->splitPersons('test_value', 42, 'test_value', 'test_value');
        $this->assertStringContainsString('/api/v1/person/test_value/split/42/', $ctx->client->lastCall()['path']);
    }
    ...
    public function test_get_get_all_persons_from_project_path(): void {
        ...
        $obj = new Person($ctx);
        $obj->getAllPersonsFromProject('test_value');
        $this->assertStringContainsString('/api/v1/person/test_value/', $ctx->client->lastCall()['path']);
    }
    ...
    public function test_get_get_all_person_names_from_project_path(): void {
        ...
        $obj = new Person($ctx);
        $obj->getAllPersonNamesFromProject('test_value');
        $this->assertStringContainsString('/api/v1/person/test_value/names', $ctx->client->lastCall()['path']);
    }
    ...
    public function test_get_get_all_persons_from_photo_path(): void {
        ...
        $obj = new Person($ctx);
        $obj->getAllPersonsFromPhoto('test_value', 42);
        $this->assertStringContainsString('/api/v1/person/test_value/photo/42', $ctx->client->lastCall()['path']);
    }
