...
class AiModelCredits {
    ...
    public function getModelCreditRelationship(mixed $modelName): mixed {
    ...
    public function upsertModelCreditRelationship(mixed $modelName = null, mixed $newCreditValue = null): mixed {
        $this->ctx->requireTokens();
