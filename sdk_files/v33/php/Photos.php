...
class Photos {
    ...
    public function getPhotoFaceDetailsFromProject(mixed $tableName, mixed $photoId): mixed {
        $this->ctx->requireTokens();
    ...
    public function getTopMiddleBottomProjectPhotoIds(mixed $tableName, mixed $ascOrDesc = null): mixed {
        $this->ctx->requireTokens();
    ...
    public function getTopMiddleBottomProjectPhotosByTableNameSortedByDateNewRanked(mixed $tableName, mixed $ascOrDesc = null): mixed {
        $this->ctx->requireTokens();
    ...
    public function getTopMiddleBottomProjectPhotosByTableNameSortedByDateNewRankedKeysetPaginated(
        mixed $tableName,
        mixed $ascOrDesc = null,
        mixed $lastId = null,
        mixed $limit = null
    ...
    public function getProjectMonthYearsWithPhotos(mixed $tableName): mixed {
        $this->ctx->requireTokens();
    ...
    public function getTopMiddleBottomProjectPhotosByTableNameByMonthSortedByDateNewRankedKeysetPaginated(
        mixed $tableName,
        mixed $month,
        mixed $year,
        mixed $ascOrDesc = null,
    ...
    public function getTopProjectPhotosByTableNameNoDateTakenRanked(mixed $tableName, mixed $ascOrDesc = null): mixed {
        $this->ctx->requireTokens();
    ...
    public function getProjectThumbnail(mixed $tableName): mixed {
        $this->ctx->requireTokens();
