...
describe('Photos', () => {
  ...
  it('getPhotoFromProject — HTTP method is GET', async () => {
    const spy = new SpyOAuthClient();
    await getPhotoFromProject(spy, 'access_token', 'refresh_token', 'test_value', 42, { keywordListId: 42 });
    expect(spy.last_call().method).toBe('GET');
  });
  ...
  it('getProjectMonthYearsWithPhotos — HTTP method is GET', async () => {
    const spy = new SpyOAuthClient();
    await getProjectMonthYearsWithPhotos(spy, 'access_token', 'refresh_token', 'test_value');
    expect(spy.last_call().method).toBe('GET');
  });
  ...
  it('getProjectPhotoIdsByMonth — HTTP method is GET', async () => {
    const spy = new SpyOAuthClient();
    await getProjectPhotoIdsByMonth(spy, 'access_token', 'refresh_token', 'test_value', 42, 42, { ascOrDesc: 'test_value' });
    expect(spy.last_call().method).toBe('GET');
  });
  ...
  it('getProjectPhotoIdsNoDateTaken — HTTP method is GET', async () => {
    const spy = new SpyOAuthClient();
    await getProjectPhotoIdsNoDateTaken(spy, 'access_token', 'refresh_token', 'test_value');
    expect(spy.last_call().method).toBe('GET');
  });
  ...
  it('updatePhotoRanking — HTTP method is PUT', async () => {
    const spy = new SpyOAuthClient();
    await updatePhotoRanking(spy, 'access_token', 'refresh_token', 'test_value', 42, 'test_value');
  ...
  it('getTopMiddleBottomProjectPhotosByTableNameSortedByDateNewRanked — HTTP method is GET', async () => {
    const spy = new SpyOAuthClient();
    await getTopMiddleBottomProjectPhotosByTableNameSortedByDateNewRanked(spy, 'access_token', 'refresh_token', 'test_value', { ascOrDesc: 'test_value' });
    expect(spy.last_call().method).toBe('GET');
  });
  ...
  it('getTopMiddleBottomProjectPhotosByTableNameByMonthSortedByDateNewRanked — HTTP method is GET', async () => {
    const spy = new SpyOAuthClient();
    await getTopMiddleBottomProjectPhotosByTableNameByMonthSortedByDateNewRanked(spy, 'access_token', 'refresh_token', 'test_value', 42, 42, { ascOrDesc: 'test_value' });
    expect(spy.last_call().method).toBe('GET');
  });
  ...
  it('getTopProjectPhotosByTableNameNoDateTakenNewRanked — HTTP method is GET', async () => {
    const spy = new SpyOAuthClient();
    await getTopProjectPhotosByTableNameNoDateTakenNewRanked(spy, 'access_token', 'refresh_token', 'test_value', { ascOrDesc: 'test_value' });
    expect(spy.last_call().method).toBe('GET');
  });
