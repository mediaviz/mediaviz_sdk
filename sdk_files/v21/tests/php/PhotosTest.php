...
class PhotosTest extends TestCase {
    ...
    public function test_get_get_photo_from_project_http_method(): void {
        $spy = new \OAuthSdk\SpyOAuthClient();
        $obj = new Photos($spy);
        $obj->getPhotoFromProject('access_token', 'refresh_token', 'test_value', 42, 42);
        $this->assertSame('GET', $spy->lastCall()['method']);
    }
    ...
    public function test_get_get_project_month_years_with_photos_http_method(): void {
        $spy = new \OAuthSdk\SpyOAuthClient();
        $obj = new Photos($spy);
        $obj->getProjectMonthYearsWithPhotos('access_token', 'refresh_token', 'test_value');
        $this->assertSame('GET', $spy->lastCall()['method']);
    }
    ...
    public function test_get_get_project_photo_ids_by_month_http_method(): void {
        $spy = new \OAuthSdk\SpyOAuthClient();
        $obj = new Photos($spy);
        $obj->getProjectPhotoIdsByMonth('access_token', 'refresh_token', 'test_value', 42, 42, 'test_value');
        $this->assertSame('GET', $spy->lastCall()['method']);
    }
    ...
    public function test_get_get_project_photo_ids_no_date_taken_http_method(): void {
        $spy = new \OAuthSdk\SpyOAuthClient();
        $obj = new Photos($spy);
        $obj->getProjectPhotoIdsNoDateTaken('access_token', 'refresh_token', 'test_value');
        $this->assertSame('GET', $spy->lastCall()['method']);
    }
    ...
    public function test_put_update_photo_ranking_http_method(): void {
        $spy = new \OAuthSdk\SpyOAuthClient();
        $obj = new Photos($spy);
        $obj->updatePhotoRanking('access_token', 'refresh_token', 'test_value', 42, 'test_value');
    ...
    public function test_get_get_top_middle_bottom_project_photos_by_table_name_sorted_by_date_new_ranked_http_method(): void {
        $spy = new \OAuthSdk\SpyOAuthClient();
        $obj = new Photos($spy);
        $obj->getTopMiddleBottomProjectPhotosByTableNameSortedByDateNewRanked('access_token', 'refresh_token', 'test_value', 'test_value');
        $this->assertSame('GET', $spy->lastCall()['method']);
    }
    ...
    public function test_get_get_top_middle_bottom_project_photos_by_table_name_by_month_sorted_by_date_new_ranked_http_method(): void {
        $spy = new \OAuthSdk\SpyOAuthClient();
        $obj = new Photos($spy);
        $obj->getTopMiddleBottomProjectPhotosByTableNameByMonthSortedByDateNewRanked('access_token', 'refresh_token', 'test_value', 42, 42, 'test_value');
        $this->assertSame('GET', $spy->lastCall()['method']);
    }
    ...
    public function test_get_get_top_project_photos_by_table_name_no_date_taken_new_ranked_http_method(): void {
        $spy = new \OAuthSdk\SpyOAuthClient();
        $obj = new Photos($spy);
        $obj->getTopProjectPhotosByTableNameNoDateTakenNewRanked('access_token', 'refresh_token', 'test_value', 'test_value');
        $this->assertSame('GET', $spy->lastCall()['method']);
    }
