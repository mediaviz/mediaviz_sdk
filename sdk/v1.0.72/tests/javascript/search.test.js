...
describe('Search', () => {
  ...
  it('searchProjectPhotosParametrized — HTTP method is GET', async () => {
    ...
    const ctx = { client: spy, accessToken: 'access_token', refreshToken: 'refresh_token', requireTokens: () => {} };
    const search = new Search(ctx);
    await search.searchProjectPhotosParametrized('test_value', { andParams: 'test_value', orParams: 'test_value', notParams: 'test_value', dateMin: 'test_value', dateMax: 'test_value', dateNullAnd: 'test_value', dateNullOr: 'test_value', dateOrder: 'test_value', size: 42 });
    expect(spy.last_call().method).toBe('GET');
  });
  ...
  it('searchProjectPhotosParametrized — path construction', async () => {
    ...
    const ctx = { client: spy, accessToken: 'access_token', refreshToken: 'refresh_token', requireTokens: () => {} };
    const search = new Search(ctx);
    await search.searchProjectPhotosParametrized('hello world', { andParams: 'test_value', orParams: 'test_value', notParams: 'test_value', dateMin: 'test_value', dateMax: 'test_value', dateNullAnd: 'test_value', dateNullOr: 'test_value', dateOrder: 'test_value', size: 42 });
  ...
  it('searchProjectPhotosNaturalLanguageAuto — HTTP method is POST', async () => {
    ...
    const ctx = { client: spy, accessToken: 'access_token', refreshToken: 'refresh_token', requireTokens: () => {} };
    const search = new Search(ctx);
    await search.searchProjectPhotosNaturalLanguageAuto('test_value', 'test_value', 42, { minCosine: 3.14, labelMinCosine: 3.14, labelTopK: 42, labelDelta: 3.14, debugScores: true });
  ...
  it('searchProjectPhotosNaturalLanguageAuto — path construction', async () => {
    ...
    const ctx = { client: spy, accessToken: 'access_token', refreshToken: 'refresh_token', requireTokens: () => {} };
    const search = new Search(ctx);
    await search.searchProjectPhotosNaturalLanguageAuto('hello world', 'test_value', 42, { minCosine: 3.14, labelMinCosine: 3.14, labelTopK: 42, labelDelta: 3.14, debugScores: true });
