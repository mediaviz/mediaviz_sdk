...
class PhotosTest extends TestCase {
    ...
    public function test_put_update_photo_in_project_http_method(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->updatePhotoInProject('test_value', 42, 'test_value', 'test_value', 'test_value', ['item1', 'item2']);
    ...
    public function test_put_update_photo_in_project_path(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->updatePhotoInProject('hello world', 42, 'test_value', 'test_value', 'test_value', ['item1', 'item2']);
        $this->assertStringContainsString('/api/v1/photos_update/hello%20world/id/42', $ctx->client->lastCall()['path']);
    }

    public function test_put_update_photo_in_project_request_body(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->updatePhotoInProject('test_value', 42, 'test_value', 'test_value', 'test_value', ['item1', 'item2']);
