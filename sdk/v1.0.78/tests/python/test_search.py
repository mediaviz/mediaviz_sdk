...
def test_get_search_project_photos_parametrized_http_method(mv_client, spy_client):
    spy_client.reset()
    mv_client.search.search_project_photos_parametrized('test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 42)
    assert spy_client.last_call()['method'] == 'GET'

def test_get_search_project_photos_parametrized_path(mv_client, spy_client):
    spy_client.reset()
    mv_client.search.search_project_photos_parametrized('hello world', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 42)
