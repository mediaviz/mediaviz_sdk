...
class SearchTest extends TestCase {
    ...
    public function test_post_search_project_photos_natural_language_hybrid_exists(): void {
        $this->assertTrue(method_exists(Search::class, 'searchProjectPhotosNaturalLanguageHybrid'));
    }

    public function test_post_search_project_photos_natural_language_hybrid_http_method(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Search($ctx);
        $obj->searchProjectPhotosNaturalLanguageHybrid('test_value', 'test_value', 42, 'test_value', 3.14);
        $this->assertSame('POST', $ctx->client->lastCall()['method']);
    }

    public function test_post_search_project_photos_natural_language_hybrid_path(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Search($ctx);
        $obj->searchProjectPhotosNaturalLanguageHybrid('hello world', 'test_value', 42, 'test_value', 3.14);
        $this->assertStringContainsString('/api/v1/search/nl_hybrid/hello%20world/', $ctx->client->lastCall()['path']);
    }

    public function test_post_search_project_photos_natural_language_hybrid_query_params(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Search($ctx);
        $obj->searchProjectPhotosNaturalLanguageHybrid('test_value', 'test_value', 42, 'test_value', 3.14);
        $path = $ctx->client->lastCall()['path'];
    ...
    public function test_post_search_project_photos_natural_language_hybrid_request_body(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Search($ctx);
        $obj->searchProjectPhotosNaturalLanguageHybrid('test_value', 'test_value', 42, 'test_value', 3.14);
        $body = $ctx->client->lastCall()['body'];
    ...
    public function test_post_search_project_photos_natural_language_hybrid_auth_routing(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Search($ctx);
        $obj->searchProjectPhotosNaturalLanguageHybrid('test_value', 'test_value', 42, 'test_value', 3.14);
        $this->assertCount(1, $ctx->client->calls);
    ...
    public function test_post_search_project_photos_natural_language_auto_http_method(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Search($ctx);
        $obj->searchProjectPhotosNaturalLanguageAuto('test_value', 'test_value', 42, 'test_value', 3.14, 3.14, 42, 3.14, true);
        $this->assertSame('POST', $ctx->client->lastCall()['method']);
    }
    ...
    public function test_post_search_project_photos_natural_language_auto_path(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Search($ctx);
        $obj->searchProjectPhotosNaturalLanguageAuto('hello world', 'test_value', 42, 'test_value', 3.14, 3.14, 42, 3.14, true);
