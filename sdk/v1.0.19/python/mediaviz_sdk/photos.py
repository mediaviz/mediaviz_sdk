...
class Photos:
    ...
    def get_ranked_project_photos_by_table_name(
        self,
        table_name: str,
        asc_or_desc: str | None = None,
        last_id: Any | None = None,
    ...
    def get_ranked_project_photos_by_table_name_by_month(
        self,
        table_name: str,
        month: int,
        year: int,
    ...
    def get_project_photo_ids_no_date_taken(
        self,
        table_name: str,
        asc_or_desc: str | None = None,
        last_id: Any | None = None,
    ...
    def get_ranked_project_photos_by_table_name_no_date_taken(
        self,
        table_name: str,
        asc_or_desc: str | None = None,
        last_id: Any | None = None,
