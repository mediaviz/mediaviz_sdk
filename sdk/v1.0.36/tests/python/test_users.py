...
def test_put_update_user_by_admin_http_method(mv_client, spy_client):
    spy_client.reset()
    mv_client.users.update_user_by_admin(42, name='test_value', email='user@example.com', password='test_value', companyId=42, accountType=42, profilePicture='test_value', location='test_value', phoneNumber='test_value', birthday='2024-01-01')
    assert spy_client.last_call()['method'] == 'PUT'
