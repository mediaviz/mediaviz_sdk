(function (global, factory) {
	...
	class Photos {
	  ...
	  async getAllProjectPhotoIds(tableName, { ascOrDesc, lastId, limit, includeAll, startDate, endDate, noDateTaken } = {}) {
	    this._ctx.requireTokens();
	  ...
	  async getRankedProjectPhotosByTableName(tableName, { ascOrDesc, lastId, limit, startDate, endDate, noDateTaken } = {}) {
	    this._ctx.requireTokens();
