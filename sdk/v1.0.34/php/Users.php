...
class Users {
    ...
    public function getAllUsers(
        ...
        $this->ctx->requireTokens();
        $path = "/api/v1/users/admin/sort/" . rawurlencode((string)$ascOrDesc) . "/";
        $query = [];
    ...
    public function updateUserByAdmin(
        ...
        $this->ctx->requireTokens();
        $path = "/api/v1/users/admin/" . rawurlencode((string)$userId);
        $body = array_filter([
            'name' => $name,
            'email' => $email,
            'password' => $password,
    ...
    public function deleteUser(int $userId, ?int $newCompanyOwnerId = null): mixed {
        $this->ctx->requireTokens();
