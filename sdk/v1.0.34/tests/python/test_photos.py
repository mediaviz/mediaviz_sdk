...
def test_get_get_all_project_photo_ids_http_method(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_all_project_photo_ids('test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value')
    assert spy_client.last_call()['method'] == 'GET'

def test_get_get_all_project_photo_ids_path(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_all_project_photo_ids('hello world', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value')
...
def test_get_get_ranked_project_photos_by_table_name_http_method(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_ranked_project_photos_by_table_name('test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value')
    assert spy_client.last_call()['method'] == 'GET'

def test_get_get_ranked_project_photos_by_table_name_path(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_ranked_project_photos_by_table_name('hello world', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value')
