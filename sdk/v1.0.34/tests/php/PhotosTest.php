...
class PhotosTest extends TestCase {
    ...
    public function test_get_get_all_project_photo_ids_http_method(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getAllProjectPhotoIds('test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value');
        $this->assertSame('GET', $ctx->client->lastCall()['method']);
    }
    ...
    public function test_get_get_all_project_photo_ids_path(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getAllProjectPhotoIds('hello world', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value');
    ...
    public function test_get_get_ranked_project_photos_by_table_name_http_method(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getRankedProjectPhotosByTableName('test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value');
        $this->assertSame('GET', $ctx->client->lastCall()['method']);
    }
    ...
    public function test_get_get_ranked_project_photos_by_table_name_path(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getRankedProjectPhotosByTableName('hello world', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value');
