...
class KeywordsTest extends TestCase {
    ...
    public function test_post_add_company_to_keyword_filtering_list_exists(): void {
        $this->assertTrue(method_exists(Keywords::class, 'addCompanyToKeywordFilteringList'));
    }

    public function test_post_add_company_to_keyword_filtering_list_http_method(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Keywords($ctx);
        $obj->addCompanyToKeywordFilteringList(42, 42);
        $this->assertSame('POST', $ctx->client->lastCall()['method']);
    }

    public function test_post_add_company_to_keyword_filtering_list_path(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Keywords($ctx);
        $obj->addCompanyToKeywordFilteringList(42, 42);
        $this->assertStringContainsString('/api/v1/keyword/42/company', $ctx->client->lastCall()['path']);
    }

    public function test_post_add_company_to_keyword_filtering_list_query_params(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Keywords($ctx);
        $obj->addCompanyToKeywordFilteringList(42, 42);
        $path = $ctx->client->lastCall()['path'];
    ...
    public function test_post_add_company_to_keyword_filtering_list_auth_routing(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Keywords($ctx);
        $obj->addCompanyToKeywordFilteringList(42, 42);
        $this->assertCount(1, $ctx->client->calls);
    ...
    public function test_delete_remove_company_from_keyword_filtering_list_exists(): void {
        $this->assertTrue(method_exists(Keywords::class, 'removeCompanyFromKeywordFilteringList'));
    }

    public function test_delete_remove_company_from_keyword_filtering_list_http_method(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Keywords($ctx);
        $obj->removeCompanyFromKeywordFilteringList(42, 42);
        $this->assertSame('DELETE', $ctx->client->lastCall()['method']);
    }

    public function test_delete_remove_company_from_keyword_filtering_list_path(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Keywords($ctx);
        $obj->removeCompanyFromKeywordFilteringList(42, 42);
        $this->assertStringContainsString('/api/v1/keyword/42/company', $ctx->client->lastCall()['path']);
    ...
    public function test_delete_remove_company_from_keyword_filtering_list_query_params(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Keywords($ctx);
        $obj->removeCompanyFromKeywordFilteringList(42, 42);
        $path = $ctx->client->lastCall()['path'];
    ...
    public function test_delete_remove_company_from_keyword_filtering_list_auth_routing(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Keywords($ctx);
        $obj->removeCompanyFromKeywordFilteringList(42, 42);
        $this->assertCount(1, $ctx->client->calls);
