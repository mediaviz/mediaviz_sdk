...
from mediaviz_webhooks import WebhookConsumer
    ...
    def __init__(
        ...
        *,
        ...
        self._hosts: dict[str, str | None] = {
            ...
            'webhookReceiver': _h.get('webhookReceiver') or os.environ.get('MEDIAVIZ_WEBHOOK_RECEIVER_URL'),
        }
        ...
        self.subscription = Subscription(_ctx)
        self.users = Users(_ctx)
        self.webhook_receiver = WebhookReceiver(_ctx)
        self.webhooks = WebhookConsumer(_ctx, self.subscription)
