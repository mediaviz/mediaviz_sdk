...
class Person:
    ...
    def remove_person_name(self, project_table_name: str, person_id: str) -> dict[str, Any]:
        self._ctx.require_tokens()
        path = '/api/v1/person/' + quote(str(project_table_name), safe='') + '/remove_name/' + quote(str(person_id), safe='')
        return self._ctx.client.request(path, 'PUT', self._ctx.access_token, self._ctx.refresh_token).data
    ...
    def remove_person(self, project_table_name: str, person_id: str) -> dict[str, Any]:
        self._ctx.require_tokens()
        path = '/api/v1/person/' + quote(str(project_table_name), safe='') + '/' + quote(str(person_id), safe='')
