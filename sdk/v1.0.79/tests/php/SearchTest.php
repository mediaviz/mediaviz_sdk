...
class SearchTest extends TestCase {
    ...
    public function test_get_search_project_photos_parametrized_http_method(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Search($ctx);
        $obj->searchProjectPhotosParametrized('test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 42);
        $this->assertSame('GET', $ctx->client->lastCall()['method']);
    }
    ...
    public function test_get_search_project_photos_parametrized_path(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Search($ctx);
        $obj->searchProjectPhotosParametrized('hello world', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 'test_value', 42);
