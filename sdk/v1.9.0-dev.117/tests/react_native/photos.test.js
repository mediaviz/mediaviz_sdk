...
import { Photos } from '../../react_native/photos.js';
...
describe('Photos', () => {
  ...
  it('getProjectPhotoIdsByTableName — exists', () => {
    const photos = new Photos({});
    expect(typeof photos.getProjectPhotoIdsByTableName).toBe('function');
  });

  it('getProjectPhotoIdsByTableName — HTTP method is GET', async () => {
    const spy = new SpyOAuthClient();
    const ctx = { client: spy, accessToken: 'access_token', refreshToken: 'refresh_token', requireTokens: () => {} };
    const photos = new Photos(ctx);
    await photos.getProjectPhotoIdsByTableName('test_value', { ascOrDesc: 'test_value', lastId: 'test_value', limit: 'test_value', includeAll: 'test_value', startDate: 'test_value', endDate: 'test_value', noDateTaken: 'test_value' });
    expect(spy.last_call().method).toBe('GET');
  });

  it('getProjectPhotoIdsByTableName — path construction', async () => {
    const spy = new SpyOAuthClient();
    const ctx = { client: spy, accessToken: 'access_token', refreshToken: 'refresh_token', requireTokens: () => {} };
    const photos = new Photos(ctx);
    await photos.getProjectPhotoIdsByTableName('hello world', { ascOrDesc: 'test_value', lastId: 'test_value', limit: 'test_value', includeAll: 'test_value', startDate: 'test_value', endDate: 'test_value', noDateTaken: 'test_value' });
    expect(spy.last_call().path).toContain('/api/v1/photos/hello%20world/');
  });

  it('getProjectPhotoIdsByTableName — query params', async () => {
    const spy = new SpyOAuthClient();
    const ctx = { client: spy, accessToken: 'access_token', refreshToken: 'refresh_token', requireTokens: () => {} };
    const photos = new Photos(ctx);
    await photos.getProjectPhotoIdsByTableName('test_value', { ascOrDesc: 'test_value', lastId: 'test_value', limit: 'test_value', includeAll: 'test_value', startDate: 'test_value', endDate: 'test_value', noDateTaken: 'test_value' });
  ...
  it('getProjectPhotoIdsByTableName — auth routing', async () => {
    const spy = new SpyOAuthClient();
    const ctx = { client: spy, accessToken: 'access_token', refreshToken: 'refresh_token', requireTokens: () => {} };
    const photos = new Photos(ctx);
    await photos.getProjectPhotoIdsByTableName('test_value', { ascOrDesc: 'test_value', lastId: 'test_value', limit: 'test_value', includeAll: 'test_value', startDate: 'test_value', endDate: 'test_value', noDateTaken: 'test_value' });
  ...
  it('getRankedProjectPhotoIdsByTableName — exists', () => {
    const photos = new Photos({});
    expect(typeof photos.getRankedProjectPhotoIdsByTableName).toBe('function');
  });

  it('getRankedProjectPhotoIdsByTableName — HTTP method is GET', async () => {
    const spy = new SpyOAuthClient();
    const ctx = { client: spy, accessToken: 'access_token', refreshToken: 'refresh_token', requireTokens: () => {} };
    const photos = new Photos(ctx);
    await photos.getRankedProjectPhotoIdsByTableName('test_value', { ascOrDesc: 'test_value', lastId: 'test_value', limit: 'test_value', startDate: 'test_value', endDate: 'test_value', noDateTaken: 'test_value' });
    expect(spy.last_call().method).toBe('GET');
  });

  it('getRankedProjectPhotoIdsByTableName — path construction', async () => {
    const spy = new SpyOAuthClient();
    const ctx = { client: spy, accessToken: 'access_token', refreshToken: 'refresh_token', requireTokens: () => {} };
    const photos = new Photos(ctx);
    await photos.getRankedProjectPhotoIdsByTableName('hello world', { ascOrDesc: 'test_value', lastId: 'test_value', limit: 'test_value', startDate: 'test_value', endDate: 'test_value', noDateTaken: 'test_value' });
    expect(spy.last_call().path).toContain('/api/v1/photos/ranked/hello%20world/');
  });

  it('getRankedProjectPhotoIdsByTableName — query params', async () => {
    const spy = new SpyOAuthClient();
    const ctx = { client: spy, accessToken: 'access_token', refreshToken: 'refresh_token', requireTokens: () => {} };
    const photos = new Photos(ctx);
    await photos.getRankedProjectPhotoIdsByTableName('test_value', { ascOrDesc: 'test_value', lastId: 'test_value', limit: 'test_value', startDate: 'test_value', endDate: 'test_value', noDateTaken: 'test_value' });
  ...
  it('getRankedProjectPhotoIdsByTableName — auth routing', async () => {
    const spy = new SpyOAuthClient();
    const ctx = { client: spy, accessToken: 'access_token', refreshToken: 'refresh_token', requireTokens: () => {} };
    const photos = new Photos(ctx);
    await photos.getRankedProjectPhotoIdsByTableName('test_value', { ascOrDesc: 'test_value', lastId: 'test_value', limit: 'test_value', startDate: 'test_value', endDate: 'test_value', noDateTaken: 'test_value' });
  ...
  it('updatePhotoInProject — HTTP method is PUT', async () => {
    ...
    const ctx = { client: spy, accessToken: 'access_token', refreshToken: 'refresh_token', requireTokens: () => {} };
    const photos = new Photos(ctx);
    await photos.updatePhotoInProject('test_value', 42, { filePath: 'test_value', title: 'test_value', description: 'test_value', tags: ['item1', 'item2'] });
  ...
  it('updatePhotoInProject — path construction', async () => {
    ...
    const ctx = { client: spy, accessToken: 'access_token', refreshToken: 'refresh_token', requireTokens: () => {} };
    const photos = new Photos(ctx);
    await photos.updatePhotoInProject('hello world', 42, { filePath: 'test_value', title: 'test_value', description: 'test_value', tags: ['item1', 'item2'] });
    expect(spy.last_call().path).toContain('/api/v1/photos_update/hello%20world/id/42');
  });

  it('updatePhotoInProject — request body', async () => {
    const spy = new SpyOAuthClient();
    const ctx = { client: spy, accessToken: 'access_token', refreshToken: 'refresh_token', requireTokens: () => {} };
    const photos = new Photos(ctx);
    await photos.updatePhotoInProject('test_value', 42, { filePath: 'test_value', title: 'test_value', description: 'test_value', tags: ['item1', 'item2'] });
