...
class ProjectsTest extends TestCase {
    ...
    public function test_post_create_project_and_run_http_method(): void {
        ...
        $obj->createProjectAndRun('test_value', 42, true, 'test_value', 'test_value', 42, 'test_value', 'test_value', 'test_value', 'test_value');
    ...
    public function test_get_get_project_process_status_exists(): void {
        $this->assertTrue(method_exists(Projects::class, 'getProjectProcessStatus'));
    }

    public function test_get_get_project_process_status_http_method(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Projects($ctx);
        $obj->getProjectProcessStatus('test_value', 'test_value');
        $this->assertSame('GET', $ctx->client->lastCall()['method']);
    }

    public function test_get_get_project_process_status_path(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Projects($ctx);
        $obj->getProjectProcessStatus('hello world', 'hello world');
        $this->assertStringContainsString('/api/v1/projects/hello%20world/process_status/hello%20world', $ctx->client->lastCall()['path']);
    }

    public function test_get_get_project_process_status_auth_routing(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Projects($ctx);
        $obj->getProjectProcessStatus('test_value', 'test_value');
        $this->assertCount(1, $ctx->client->calls);
