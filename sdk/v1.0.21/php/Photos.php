...
class Photos {
    ...
    public function getRankedProjectPhotosByTableName(
        string $tableName,
        ?string $ascOrDesc = null,
        mixed $lastId = null,
        mixed $limit = null
    ...
    public function getRankedProjectPhotosByTableNameByMonth(
        string $tableName,
        int $month,
        int $year,
        ?string $ascOrDesc = null,
    ...
    public function getRankedProjectPhotosByTableNameNoDateTaken(
        string $tableName,
        ?string $ascOrDesc = null,
        mixed $lastId = null,
        mixed $limit = null
