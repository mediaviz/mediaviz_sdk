...
class PhotosTest extends TestCase {
    ...
    public function test_get_get_all_project_photo_ids_http_method(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getAllProjectPhotoIds('test_value', 'test_value', 'test_value', 'test_value', 'test_value');
        $this->assertSame('GET', $ctx->client->lastCall()['method']);
    }
    ...
    public function test_get_get_all_project_photo_ids_path(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getAllProjectPhotoIds('hello world', 'test_value', 'test_value', 'test_value', 'test_value');
    ...
    public function test_get_get_ranked_project_photos_by_table_name_exists(): void {
        $this->assertTrue(method_exists(Photos::class, 'getRankedProjectPhotosByTableName'));
    }

    public function test_get_get_ranked_project_photos_by_table_name_http_method(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getRankedProjectPhotosByTableName('test_value', 'test_value', 'test_value', 'test_value');
        $this->assertSame('GET', $ctx->client->lastCall()['method']);
    }

    public function test_get_get_ranked_project_photos_by_table_name_path(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getRankedProjectPhotosByTableName('hello world', 'test_value', 'test_value', 'test_value');
        $this->assertStringContainsString('/api/v1/photos_ranked/hello%20world/', $ctx->client->lastCall()['path']);
    }

    public function test_get_get_ranked_project_photos_by_table_name_query_params(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getRankedProjectPhotosByTableName('test_value', 'test_value', 'test_value', 'test_value');
        $path = $ctx->client->lastCall()['path'];
    ...
    public function test_get_get_ranked_project_photos_by_table_name_auth_routing(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getRankedProjectPhotosByTableName('test_value', 'test_value', 'test_value', 'test_value');
        $this->assertCount(1, $ctx->client->calls);
    ...
    public function test_get_get_project_photo_ids_by_month_http_method(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getProjectPhotoIdsByMonth('test_value', 42, 42, 'test_value', 'test_value', 'test_value');
        $this->assertSame('GET', $ctx->client->lastCall()['method']);
    }
    ...
    public function test_get_get_project_photo_ids_by_month_path(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getProjectPhotoIdsByMonth('hello world', 42, 42, 'test_value', 'test_value', 'test_value');
    ...
    public function test_get_get_ranked_project_photos_by_table_name_by_month_exists(): void {
        $this->assertTrue(method_exists(Photos::class, 'getRankedProjectPhotosByTableNameByMonth'));
    }

    public function test_get_get_ranked_project_photos_by_table_name_by_month_http_method(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getRankedProjectPhotosByTableNameByMonth('test_value', 42, 42, 'test_value', 'test_value', 'test_value');
        $this->assertSame('GET', $ctx->client->lastCall()['method']);
    }

    public function test_get_get_ranked_project_photos_by_table_name_by_month_path(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getRankedProjectPhotosByTableNameByMonth('hello world', 42, 42, 'test_value', 'test_value', 'test_value');
        $this->assertStringContainsString('/api/v1/photos/hello%20world/month/42/year/42/ranked/', $ctx->client->lastCall()['path']);
    }

    public function test_get_get_ranked_project_photos_by_table_name_by_month_query_params(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getRankedProjectPhotosByTableNameByMonth('test_value', 42, 42, 'test_value', 'test_value', 'test_value');
        $path = $ctx->client->lastCall()['path'];
    ...
    public function test_get_get_ranked_project_photos_by_table_name_by_month_auth_routing(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getRankedProjectPhotosByTableNameByMonth('test_value', 42, 42, 'test_value', 'test_value', 'test_value');
        $this->assertCount(1, $ctx->client->calls);
    ...
    public function test_get_get_project_photo_ids_no_date_taken_http_method(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getProjectPhotoIdsNoDateTaken('test_value', 'test_value', 'test_value', 'test_value');
        $this->assertSame('GET', $ctx->client->lastCall()['method']);
    }
    ...
    public function test_get_get_project_photo_ids_no_date_taken_path(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getProjectPhotoIdsNoDateTaken('hello world', 'test_value', 'test_value', 'test_value');
        $this->assertStringContainsString('/api/v1/photos/hello%20world/date_taken/none/', $ctx->client->lastCall()['path']);
    }

    public function test_get_get_project_photo_ids_no_date_taken_query_params(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getProjectPhotoIdsNoDateTaken('test_value', 'test_value', 'test_value', 'test_value');
        $path = $ctx->client->lastCall()['path'];
    ...
    public function test_get_get_ranked_project_photos_by_table_name_no_date_taken_exists(): void {
        $this->assertTrue(method_exists(Photos::class, 'getRankedProjectPhotosByTableNameNoDateTaken'));
    }

    public function test_get_get_ranked_project_photos_by_table_name_no_date_taken_http_method(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getRankedProjectPhotosByTableNameNoDateTaken('test_value', 'test_value', 'test_value', 'test_value');
        $this->assertSame('GET', $ctx->client->lastCall()['method']);
    }

    public function test_get_get_ranked_project_photos_by_table_name_no_date_taken_path(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getRankedProjectPhotosByTableNameNoDateTaken('hello world', 'test_value', 'test_value', 'test_value');
        $this->assertStringContainsString('/api/v1/photos/hello%20world/date_taken/none/ranked/', $ctx->client->lastCall()['path']);
    }

    public function test_get_get_ranked_project_photos_by_table_name_no_date_taken_query_params(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getRankedProjectPhotosByTableNameNoDateTaken('test_value', 'test_value', 'test_value', 'test_value');
        $path = $ctx->client->lastCall()['path'];
    ...
    public function test_get_get_ranked_project_photos_by_table_name_no_date_taken_auth_routing(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Photos($ctx);
        $obj->getRankedProjectPhotosByTableNameNoDateTaken('test_value', 'test_value', 'test_value', 'test_value');
        $this->assertCount(1, $ctx->client->calls);
