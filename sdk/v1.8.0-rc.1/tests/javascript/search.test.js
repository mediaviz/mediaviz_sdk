...
describe('Search', () => {
  ...
  it('searchProjectPhotosNaturalLanguage — HTTP method is POST', async () => {
    ...
    const ctx = { client: spy, accessToken: 'access_token', refreshToken: 'refresh_token', requireTokens: () => {} };
    const search = new Search(ctx);
    await search.searchProjectPhotosNaturalLanguage('test_value', 'test_value', { minCosine: 3.14, labelMinCosine: 3.14, labelTopK: 42, labelDelta: 3.14, bestOfSimilarSetsOnly: 'test_value', splitByTier: 'test_value' });
  ...
  it('searchProjectPhotosNaturalLanguage — path construction', async () => {
    ...
    const ctx = { client: spy, accessToken: 'access_token', refreshToken: 'refresh_token', requireTokens: () => {} };
    const search = new Search(ctx);
    await search.searchProjectPhotosNaturalLanguage('hello world', 'test_value', { minCosine: 3.14, labelMinCosine: 3.14, labelTopK: 42, labelDelta: 3.14, bestOfSimilarSetsOnly: 'test_value', splitByTier: 'test_value' });
