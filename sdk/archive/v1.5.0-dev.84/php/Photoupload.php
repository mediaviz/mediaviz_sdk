...
class Photoupload {
    ...
    public function uploadPhoto(
        ...
        if ((((($template['headers']['x-blur'] ?? null) === true || ($template['headers']['x-blur'] ?? null) === 'true') ? 'true' : null) ?? null) !== null) $_headers[] = 'x-blur: ' . ((($template['headers']['x-blur'] ?? null) === true || ($template['headers']['x-blur'] ?? null) === 'true') ? 'true' : null);
        if ((((($template['headers']['x-colors'] ?? null) === true || ($template['headers']['x-colors'] ?? null) === 'true') ? 'true' : null) ?? null) !== null) $_headers[] = 'x-colors: ' . ((($template['headers']['x-colors'] ?? null) === true || ($template['headers']['x-colors'] ?? null) === 'true') ? 'true' : null);
        if ((((($template['headers']['x-face-recognition'] ?? null) === true || ($template['headers']['x-face-recognition'] ?? null) === 'true') ? 'true' : null) ?? null) !== null) $_headers[] = 'x-face-recognition: ' . ((($template['headers']['x-face-recognition'] ?? null) === true || ($template['headers']['x-face-recognition'] ?? null) === 'true') ? 'true' : null);
        if ((((($template['headers']['x-image-describe'] ?? null) === true || ($template['headers']['x-image-describe'] ?? null) === 'true') ? 'true' : null) ?? null) !== null) $_headers[] = 'x-image-describe: ' . ((($template['headers']['x-image-describe'] ?? null) === true || ($template['headers']['x-image-describe'] ?? null) === 'true') ? 'true' : null);
        if ((((($template['headers']['x-image-classification'] ?? null) === true || ($template['headers']['x-image-classification'] ?? null) === 'true') ? 'true' : null) ?? null) !== null) $_headers[] = 'x-image-classification: ' . ((($template['headers']['x-image-classification'] ?? null) === true || ($template['headers']['x-image-classification'] ?? null) === 'true') ? 'true' : null);
        if ((((($template['headers']['x-image-comparison'] ?? null) === true || ($template['headers']['x-image-comparison'] ?? null) === 'true') ? 'true' : null) ?? null) !== null) $_headers[] = 'x-image-comparison: ' . ((($template['headers']['x-image-comparison'] ?? null) === true || ($template['headers']['x-image-comparison'] ?? null) === 'true') ? 'true' : null);
        ...
        if ((((($template['headers']['x-ocr'] ?? null) === true || ($template['headers']['x-ocr'] ?? null) === 'true') ? 'true' : null) ?? null) !== null) $_headers[] = 'x-ocr: ' . ((($template['headers']['x-ocr'] ?? null) === true || ($template['headers']['x-ocr'] ?? null) === 'true') ? 'true' : null);
        $_body = [
