...
class SearchTest extends TestCase {
    ...
    public function test_get_recall_project_photos_exists(): void {
        $this->assertTrue(method_exists(Search::class, 'recallProjectPhotos'));
    }

    public function test_get_recall_project_photos_http_method(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Search($ctx);
        $obj->recallProjectPhotos('test_value', 'test_value', 'test_value', 'test_value', 42);
        $this->assertSame('GET', $ctx->client->lastCall()['method']);
    }

    public function test_get_recall_project_photos_path(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Search($ctx);
        $obj->recallProjectPhotos('hello world', 'test_value', 'test_value', 'test_value', 42);
        $this->assertStringContainsString('/api/v1/search/recall/hello%20world/', $ctx->client->lastCall()['path']);
    }

    public function test_get_recall_project_photos_query_params(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Search($ctx);
        $obj->recallProjectPhotos('test_value', 'test_value', 'test_value', 'test_value', 42);
        $path = $ctx->client->lastCall()['path'];
    ...
    public function test_get_recall_project_photos_auth_routing(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Search($ctx);
        $obj->recallProjectPhotos('test_value', 'test_value', 'test_value', 'test_value', 42);
        $this->assertCount(1, $ctx->client->calls);
    ...
    public function test_post_search_project_photos_natural_language_http_method(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Search($ctx);
        $obj->searchProjectPhotosNaturalLanguage('test_value', 'test_value', 3.14, 3.14, 42, 3.14, 'test_value', 'test_value');
    ...
    public function test_post_search_project_photos_natural_language_path(): void {
        $ctx = new \OAuthSdk\SpyAuthContext();
        $obj = new Search($ctx);
        $obj->searchProjectPhotosNaturalLanguage('hello world', 'test_value', 3.14, 3.14, 42, 3.14, 'test_value', 'test_value');
