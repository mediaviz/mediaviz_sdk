...
def test_get_get_top_middle_bottom_project_photo_ids_exists(mv_client):
    assert callable(getattr(mv_client.photos, 'get_top_middle_bottom_project_photo_ids', None))

def test_get_get_top_middle_bottom_project_photo_ids_http_method(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_top_middle_bottom_project_photo_ids('test_value', 'test_value')
    assert spy_client.last_call()['method'] == 'GET'

def test_get_get_top_middle_bottom_project_photo_ids_path(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_top_middle_bottom_project_photo_ids('hello world', 'test_value')
    assert '/api/v1/photos_top/hello%20world' in spy_client.last_call()['url']

def test_get_get_top_middle_bottom_project_photo_ids_query_params(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_top_middle_bottom_project_photo_ids('test_value', 'test_value')
    url = spy_client.last_call()['url']
    assert 'asc_or_desc=' in url

def test_get_get_top_middle_bottom_project_photos_by_table_name_sorted_by_date_ranked_keyset_paginated_exists(mv_client):
    assert callable(getattr(mv_client.photos, 'get_top_middle_bottom_project_photos_by_table_name_sorted_by_date_ranked_keyset_paginated', None))

def test_get_get_top_middle_bottom_project_photos_by_table_name_sorted_by_date_ranked_keyset_paginated_http_method(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_top_middle_bottom_project_photos_by_table_name_sorted_by_date_ranked_keyset_paginated('test_value', 'test_value', 'test_value', 'test_value')
    assert spy_client.last_call()['method'] == 'GET'

def test_get_get_top_middle_bottom_project_photos_by_table_name_sorted_by_date_ranked_keyset_paginated_path(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_top_middle_bottom_project_photos_by_table_name_sorted_by_date_ranked_keyset_paginated('hello world', 'test_value', 'test_value', 'test_value')
    assert '/api/v1/photos_ranked/hello%20world/' in spy_client.last_call()['url']

def test_get_get_top_middle_bottom_project_photos_by_table_name_sorted_by_date_ranked_keyset_paginated_query_params(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_top_middle_bottom_project_photos_by_table_name_sorted_by_date_ranked_keyset_paginated('test_value', 'test_value', 'test_value', 'test_value')
    url = spy_client.last_call()['url']
    assert 'asc_or_desc=' in url
...
def test_get_get_project_photo_ids_by_month_http_method(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_project_photo_ids_by_month('test_value', 42, 42, 'test_value')
    assert spy_client.last_call()['method'] == 'GET'

def test_get_get_project_photo_ids_by_month_path(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_project_photo_ids_by_month('hello world', 42, 42, 'test_value')
...
def test_get_get_project_photo_ids_by_month_keyset_paginated_exists(mv_client):
    assert callable(getattr(mv_client.photos, 'get_project_photo_ids_by_month_keyset_paginated', None))

def test_get_get_project_photo_ids_by_month_keyset_paginated_http_method(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_project_photo_ids_by_month_keyset_paginated('test_value', 42, 42, 'test_value', 'test_value', 'test_value')
    assert spy_client.last_call()['method'] == 'GET'

def test_get_get_project_photo_ids_by_month_keyset_paginated_path(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_project_photo_ids_by_month_keyset_paginated('hello world', 42, 42, 'test_value', 'test_value', 'test_value')
    assert '/api/v1/photos/hello%20world/month/42/year/42/' in spy_client.last_call()['url']

def test_get_get_project_photo_ids_by_month_keyset_paginated_query_params(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_project_photo_ids_by_month_keyset_paginated('test_value', 42, 42, 'test_value', 'test_value', 'test_value')
    url = spy_client.last_call()['url']
    assert 'asc_or_desc=' in url
...
def test_get_get_top_project_photos_by_table_name_by_month_exists(mv_client):
    assert callable(getattr(mv_client.photos, 'get_top_project_photos_by_table_name_by_month', None))

def test_get_get_top_project_photos_by_table_name_by_month_http_method(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_top_project_photos_by_table_name_by_month('test_value', 42, 42, 'test_value')
    assert spy_client.last_call()['method'] == 'GET'

def test_get_get_top_project_photos_by_table_name_by_month_path(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_top_project_photos_by_table_name_by_month('hello world', 42, 42, 'test_value')
    assert '/api/v1/photos/hello%20world/month/42/year/42/top' in spy_client.last_call()['url']

def test_get_get_top_project_photos_by_table_name_by_month_query_params(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_top_project_photos_by_table_name_by_month('test_value', 42, 42, 'test_value')
    url = spy_client.last_call()['url']
    assert 'asc_or_desc=' in url

def test_get_get_top_middle_bottom_project_photos_by_table_name_by_month_sorted_by_date_ranked_keyset_paginated_exists(mv_client):
    assert callable(getattr(mv_client.photos, 'get_top_middle_bottom_project_photos_by_table_name_by_month_sorted_by_date_ranked_keyset_paginated', None))

def test_get_get_top_middle_bottom_project_photos_by_table_name_by_month_sorted_by_date_ranked_keyset_paginated_http_method(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_top_middle_bottom_project_photos_by_table_name_by_month_sorted_by_date_ranked_keyset_paginated('test_value', 42, 42, 'test_value', 'test_value', 'test_value')
    assert spy_client.last_call()['method'] == 'GET'

def test_get_get_top_middle_bottom_project_photos_by_table_name_by_month_sorted_by_date_ranked_keyset_paginated_path(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_top_middle_bottom_project_photos_by_table_name_by_month_sorted_by_date_ranked_keyset_paginated('hello world', 42, 42, 'test_value', 'test_value', 'test_value')
    assert '/api/v1/photos/hello%20world/month/42/year/42/ranked/' in spy_client.last_call()['url']

def test_get_get_top_middle_bottom_project_photos_by_table_name_by_month_sorted_by_date_ranked_keyset_paginated_query_params(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_top_middle_bottom_project_photos_by_table_name_by_month_sorted_by_date_ranked_keyset_paginated('test_value', 42, 42, 'test_value', 'test_value', 'test_value')
    url = spy_client.last_call()['url']
    assert 'asc_or_desc=' in url
...
def test_get_get_project_photo_ids_no_date_taken_keyset_paginated_exists(mv_client):
    assert callable(getattr(mv_client.photos, 'get_project_photo_ids_no_date_taken_keyset_paginated', None))

def test_get_get_project_photo_ids_no_date_taken_keyset_paginated_http_method(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_project_photo_ids_no_date_taken_keyset_paginated('test_value', 'test_value', 'test_value', 'test_value')
    assert spy_client.last_call()['method'] == 'GET'

def test_get_get_project_photo_ids_no_date_taken_keyset_paginated_path(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_project_photo_ids_no_date_taken_keyset_paginated('hello world', 'test_value', 'test_value', 'test_value')
    assert '/api/v1/photos/hello%20world/date_taken/none/' in spy_client.last_call()['url']

def test_get_get_project_photo_ids_no_date_taken_keyset_paginated_query_params(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_project_photo_ids_no_date_taken_keyset_paginated('test_value', 'test_value', 'test_value', 'test_value')
    url = spy_client.last_call()['url']
    assert 'asc_or_desc=' in url
...
def test_get_get_top_project_photos_by_table_name_no_date_taken_ranked_exists(mv_client):
    assert callable(getattr(mv_client.photos, 'get_top_project_photos_by_table_name_no_date_taken_ranked', None))

def test_get_get_top_project_photos_by_table_name_no_date_taken_ranked_http_method(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_top_project_photos_by_table_name_no_date_taken_ranked('test_value', 'test_value')
    assert spy_client.last_call()['method'] == 'GET'

def test_get_get_top_project_photos_by_table_name_no_date_taken_ranked_path(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_top_project_photos_by_table_name_no_date_taken_ranked('hello world', 'test_value')
    assert '/api/v1/photos/hello%20world/date_taken/none/ranked' in spy_client.last_call()['url']

def test_get_get_top_project_photos_by_table_name_no_date_taken_ranked_query_params(mv_client, spy_client):
    spy_client.reset()
    mv_client.photos.get_top_project_photos_by_table_name_no_date_taken_ranked('test_value', 'test_value')
    url = spy_client.last_call()['url']
    assert 'asc_or_desc=' in url
