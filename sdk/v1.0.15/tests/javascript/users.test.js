...
describe('Users', () => {
  ...
  it('updateUser — HTTP method is PUT', async () => {
    ...
    const ctx = { client: spy, accessToken: 'access_token', refreshToken: 'refresh_token', requireTokens: () => {} };
    const users = new Users(ctx);
    await users.updateUser(42, 'test_value', 'user@example.com', 'test_value', 42, 42, 'test_value', 'test_value', 'test_value', '2024-01-01');
  ...
  it('updateUserByAdmin — HTTP method is PUT', async () => {
    ...
    const ctx = { client: spy, accessToken: 'access_token', refreshToken: 'refresh_token', requireTokens: () => {} };
    const users = new Users(ctx);
    await users.updateUserByAdmin(42, 'test_value', 'user@example.com', 'test_value', 42, 42, 'test_value', 'test_value', 'test_value', '2024-01-01');
    expect(spy.last_call().method).toBe('PUT');
  });
