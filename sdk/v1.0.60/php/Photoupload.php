...
class Photoupload {
    ...
    public function uploadPhotoToMediaviz(
        ...
        if ($companyId !== null) $headers[] = 'x-company-id: ' . $companyId;
        if ($userId !== null) $headers[] = 'x-user-id: ' . $userId;
        if ($projectTableName !== null) $headers[] = 'x-project-table-name: ' . $projectTableName;
        if ($clientSideId !== null) $headers[] = 'x-client-side-id: ' . $clientSideId;
        if ($title !== null) $headers[] = 'x-title: ' . $title;
        ...
        if ($bucketName !== null) $headers[] = 'x-bucket-name: ' . $bucketName;
        if ($photoIndex !== null) $headers[] = 'x-photo-index: ' . $photoIndex;
        $body = [
    ...
    public function uploadPhoto(
        ...
        if (($companyId ?? null) !== null) $_headers[] = 'x-company-id: ' . $companyId;
        if (($userId ?? null) !== null) $_headers[] = 'x-user-id: ' . $userId;
        if (($projectTableName ?? null) !== null) $_headers[] = 'x-project-table-name: ' . $projectTableName;
        if (($photo['client_side_id'] ?? null) !== null) $_headers[] = 'x-client-side-id: ' . $photo['client_side_id'];
        if (($photo['title'] ?? null) !== null) $_headers[] = 'x-title: ' . $photo['title'];
        ...
        if (($template['bucket_name'] ?? null) !== null) $_headers[] = 'x-bucket-name: ' . $template['bucket_name'];
        if (($photoIndex ?? null) !== null) $_headers[] = 'x-photo-index: ' . $photoIndex;
        $_body = [
