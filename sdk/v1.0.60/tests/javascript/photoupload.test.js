...
describe('PhotoUpload', () => {
  ...
  it('uploadPhotoToMediaviz — HTTP method is POST', async () => {
    ...
    await photoupload.uploadPhotoToMediaviz({ fileContent: 'test_value', mimetype: 'test_value', filePath: 'test_value' }, { companyId: 'test_value', userId: 'test_value', projectTableName: 'test_value', clientSideId: 'test_value', title: 'test_value', blur: 'test_value', colors: 'test_value', faceRecognition: 'test_value', imageDescribe: 'test_value', imageClassification: 'test_value', imageComparison: 'test_value', size: 'test_value', sourceResolutionX: 'test_value', sourceResolutionY: 'test_value', dateTaken: 'test_value', latitude: 'test_value', longitude: 'test_value', bucketName: 'test_value', photoIndex: 'test_value' });
