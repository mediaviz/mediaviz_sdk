...
class PhotoUpload:
    ...
    def upload_photo_to_mediaviz(
        ...
        projectTableName: str | None = None,
        ...
        if companyId is not None:
            _headers['x-company-id'] = companyId
        if userId is not None:
            _headers['x-user-id'] = userId
        if projectTableName is not None:
            _headers['x-project-table-name'] = projectTableName
        if clientSideId is not None:
            _headers['x-client-side-id'] = clientSideId
        if title is not None:
            _headers['x-title'] = title
        if blur is not None:
        ...
        if bucketName is not None:
            _headers['x-bucket-name'] = bucketName
        if photoIndex is not None:
            _headers['x-photo-index'] = photoIndex
        body = {
    ...
    def upload_photo(
        ...
        if company_id is not None:
            _headers['x-company-id'] = company_id
        if user_id is not None:
            _headers['x-user-id'] = user_id
        if project_table_name is not None:
            _headers['x-project-table-name'] = project_table_name
        if photo['client_side_id'] is not None:
            _headers['x-client-side-id'] = photo['client_side_id']
        if photo['title'] is not None:
            _headers['x-title'] = photo['title']
        ...
        if template['bucket_name'] is not None:
            _headers['x-bucket-name'] = template['bucket_name']
        if photo_index is not None:
            _headers['x-photo-index'] = photo_index
        _body = {
