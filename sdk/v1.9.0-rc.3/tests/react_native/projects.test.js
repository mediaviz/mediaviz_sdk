...
import { Projects } from '../../react_native/projects.js';
...
describe('Projects', () => {
  ...
  it('createProjectAndRun — HTTP method is POST', async () => {
    ...
    await projects.createProjectAndRun('test_value', 42, true, 'test_value', 'test_value', 42, 'test_value', 'test_value', { outcomes: 'test_value', models: 'test_value' });
