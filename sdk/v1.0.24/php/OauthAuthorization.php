...
class OauthAuthorization {
    ...
    public function authorize(?string $responseType = null, ?string $clientId = null, ?string $redirectUri = null, ?string $state = null, ?string $codeChallenge = null, ?string $codeChallengeMethod = null): mixed {
    ...
    public function getConsent(string $sessionId): mixed {
        $baseUrl = $this->ctx->baseUrl;
    ...
    public function postApproveConsent(string $sessionId): mixed {
        $baseUrl = $this->ctx->baseUrl;
    ...
    public function postDenyConsent(string $sessionId): mixed {
        $baseUrl = $this->ctx->baseUrl;
    ...
    public function getSwitchUser(string $sessionId): mixed {
        $baseUrl = $this->ctx->baseUrl;
        $path = "/oauth/consent/" . rawurlencode((string)$sessionId) . "/switch-user";
        $ch = curl_init($baseUrl . $path);
        curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($ch, CURLOPT_CUSTOMREQUEST, 'GET');
        curl_setopt($ch, CURLOPT_HEADER, true);
