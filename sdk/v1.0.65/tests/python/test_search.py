...
def test_post_search_project_photos_natural_language_auto_http_method(mv_client, spy_client):
    spy_client.reset()
    mv_client.search.search_project_photos_natural_language_auto('test_value', 'test_value', 42, 'test_value', 3.14, 3.14, 42, 3.14)
    assert spy_client.last_call()['method'] == 'POST'

def test_post_search_project_photos_natural_language_auto_path(mv_client, spy_client):
    spy_client.reset()
    mv_client.search.search_project_photos_natural_language_auto('hello world', 'test_value', 42, 'test_value', 3.14, 3.14, 42, 3.14)
