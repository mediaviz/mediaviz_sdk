...
class OauthAuthorizationTest extends TestCase {
    ...
    public function test_post_post_approve_consent_request_body(): void {
        $this->assertTrue(method_exists(OauthAuthorization::class, 'postApproveConsent'));
    }
    ...
    public function test_post_post_deny_consent_request_body(): void {
        $this->assertTrue(method_exists(OauthAuthorization::class, 'postDenyConsent'));
    }
    ...
    public function test_get_get_switch_user_exists(): void {
        $this->assertTrue(method_exists(OauthAuthorization::class, 'getSwitchUser'));
    }

    public function test_get_get_switch_user_http_method(): void {
        $this->assertTrue(method_exists(OauthAuthorization::class, 'getSwitchUser'));
    }

    public function test_get_get_switch_user_path(): void {
        $this->assertTrue(method_exists(OauthAuthorization::class, 'getSwitchUser'));
    }

    public function test_get_get_switch_user_query_params(): void {
        $this->assertTrue(method_exists(OauthAuthorization::class, 'getSwitchUser'));
    }

    public function test_get_get_switch_user_auth_routing(): void {
        $this->assertTrue(method_exists(OauthAuthorization::class, 'getSwitchUser'));
    }
